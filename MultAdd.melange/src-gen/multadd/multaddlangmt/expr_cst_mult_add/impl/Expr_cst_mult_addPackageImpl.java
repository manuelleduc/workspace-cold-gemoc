/**
 */
package multadd.multaddlangmt.expr_cst_mult_add.impl;

import multadd.multaddlangmt.expr_cst_mult_add.Add;
import multadd.multaddlangmt.expr_cst_mult_add.Cst;
import multadd.multaddlangmt.expr_cst_mult_add.Expr;
import multadd.multaddlangmt.expr_cst_mult_add.Expr_cst_mult_addFactory;
import multadd.multaddlangmt.expr_cst_mult_add.Expr_cst_mult_addPackage;
import multadd.multaddlangmt.expr_cst_mult_add.Mult;
 ...
 * @generated
 */
public class Expr_cst_mult_addPackageImpl extends EPackageImpl implements Expr_cst_mult_addPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see multadd.multaddlangmt.expr_cst_mult_add.Expr_cst_mult_addPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Expr_cst_mult_addPackageImpl() {
		super(eNS_URI, Expr_cst_mult_addFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Expr_cst_mult_addPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Expr_cst_mult_addPackage init() {
		if (isInited) return (Expr_cst_mult_addPackage)EPackage.Registry.INSTANCE.getEPackage(Expr_cst_mult_addPackage.eNS_URI);

		// Obtain or create and register package
		Expr_cst_mult_addPackageImpl theExpr_cst_mult_addPackage = (Expr_cst_mult_addPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Expr_cst_mult_addPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Expr_cst_mult_addPackageImpl());
		...
		theExpr_cst_mult_addPackage.createPackageContents();

		// Initialize created meta-data
		theExpr_cst_mult_addPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theExpr_cst_mult_addPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Expr_cst_mult_addPackage.eNS_URI, theExpr_cst_mult_addPackage);
		return theExpr_cst_mult_addPackage;
	}
	 ...
	 * @generated
	 */
	public Expr_cst_mult_addFactory getExpr_cst_mult_addFactory() {
		return (Expr_cst_mult_addFactory)getEFactoryInstance();
	}
