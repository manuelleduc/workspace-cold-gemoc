 ...
 * @generated
 */
public class MMCLangSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case MMCLangPackage.MERGE:
      {
        ...
        if (result == null) result = caseOperation(merge);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case MMCLangPackage.SLICE:
      {
        ...
        if (result == null) result = caseOperation(slice);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
