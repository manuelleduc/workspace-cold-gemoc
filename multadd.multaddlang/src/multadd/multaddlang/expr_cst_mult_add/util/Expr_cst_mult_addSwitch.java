 ...
 * @generated
 */
public class Expr_cst_mult_addSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Expr_cst_mult_addSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Expr_cst_mult_addPackage.EXPR: {
			...
			case Expr_cst_mult_addPackage.CST: {
				...
				if (result == null) result = caseExpr(cst);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
