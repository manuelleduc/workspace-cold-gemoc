...
import gfsm.model.gfsm.GfsmFactory;
import gfsm.model.gfsm.GfsmPackage;
import gfsm.model.gfsm.Guard;
import gfsm.model.gfsm.Machine;
...
public class GfsmPackageImpl extends EPackageImpl implements GfsmPackage {
	 ...
	 * @see gfsm.model.gfsm.GfsmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static GfsmPackage init() {
		if (isInited)
			return (GfsmPackage) EPackage.Registry.INSTANCE.getEPackage(GfsmPackage.eNS_URI);

		// Obtain or create and register package
		GfsmPackageImpl theGfsmPackage = (GfsmPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof GfsmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new GfsmPackageImpl());
	 ...
	 * @generated
	 */
	public EReference getState_Incommings() {
	 ...
	 * @generated
	 */
	public EReference getMachine_InitialState() {
	...
	public void initializePackageContents() {
		...
		initEReference(getTransition_From(), this.getState(), this.getState_Outgoings(), "from", null, 1, 1,
				Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_To(), this.getState(), this.getState_Incommings(), "to", null, 1, 1,
				Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransition_Event(), ecorePackage.getEString(), "event", null, 0, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Guard(), this.getGuard(), null, "guard", null, 1, 1, Transition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(stateEClass, State.class, "State", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getState_Outgoings(), this.getTransition(), this.getTransition_From(), "outgoings", null, 0, -1,
				State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_Incommings(), this.getTransition(), this.getTransition_To(), "incommings", null, 0, -1,
				State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMachine_States(), this.getState(), null, "states", null, 0, -1, Machine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getMachine_Transitions(), this.getTransition(), null, "transitions", null, 0, -1, Machine.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMachine_InitialState(), this.getState(), null, "initialState", null, 1, 1, Machine.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(guardEClass, Guard.class, "Guard", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGuard_Value(), ecorePackage.getELong(), "value", null, 0, 1, Guard.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
