...
public class AddLangEvalAdapter extends ResourceAdapter implements add.AddLangEvalMT {
  ...
  public add.addlangevalmt.expr_cst_add.Expr_cst_addFactory getExpr_cst_addFactory() {
    return new add.addlangeval.adapters.addlangevalmt.expr_cst_add.Expr_cst_addFactoryAdapter();
  }
