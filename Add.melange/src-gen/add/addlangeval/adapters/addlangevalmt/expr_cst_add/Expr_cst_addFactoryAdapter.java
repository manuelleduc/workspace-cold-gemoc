...
public class Expr_cst_addFactoryAdapter extends EFactoryImpl implements add.addlangevalmt.expr_cst_add.Expr_cst_addFactory {
  private add.addlangeval.adapters.addlangevalmt.AddLangEvalMTAdaptersFactory adaptersFactory = add.addlangeval.adapters.addlangevalmt.AddLangEvalMTAdaptersFactory.getInstance();
