 ...
 * </p>
 * <ul>
 *   <li>{@link gfsm.impl.BooleanCompareExpressionImpl#getExpression1 <em>Expression1</em>}</li>
 *   <li>{@link gfsm.impl.BooleanCompareExpressionImpl#getExpression2 <em>Expression2</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BooleanCompareExpressionImpl extends BooleanExpressionImpl implements BooleanCompareExpression {
	...
	protected EClass eStaticClass() {
		return GfsmPackage.Literals.BOOLEAN_COMPARE_EXPRESSION;
	}
	...
	public NotificationChain basicSetExpression1(IntExpression newExpression1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION1, oldExpression1, newExpression1);
	...
	public void setExpression1(IntExpression newExpression1) {
		if (newExpression1 != expression1) {
			...
			if (expression1 != null)
				msgs = ((InternalEObject)expression1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION1, null, msgs);
			if (newExpression1 != null)
				msgs = ((InternalEObject)newExpression1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION1, null, msgs);
			msgs = basicSetExpression1(newExpression1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION1, newExpression1, newExpression1));
	}
	...
	public NotificationChain basicSetExpression2(IntExpression newExpression2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION2, oldExpression2, newExpression2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExpression2(IntExpression newExpression2) {
		if (newExpression2 != expression2) {
			NotificationChain msgs = null;
			if (expression2 != null)
				msgs = ((InternalEObject)expression2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION2, null, msgs);
			if (newExpression2 != null)
				msgs = ((InternalEObject)newExpression2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION2, null, msgs);
			msgs = basicSetExpression2(newExpression2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GfsmPackage.BOOLEAN_COMPARE_EXPRESSION__EXPRESSION2, newExpression2, newExpression2));
	}
