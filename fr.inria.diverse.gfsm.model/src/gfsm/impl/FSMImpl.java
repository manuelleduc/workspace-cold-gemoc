 ...
 * </p>
 * <ul>
 *   <li>{@link gfsm.impl.FSMImpl#getStates <em>States</em>}</li>
...
public class FSMImpl extends MinimalEObjectImpl.Container implements FSM {
	...
	protected EClass eStaticClass() {
		return GfsmPackage.Literals.FSM;
	}
	...
	public EList<State> getStates() {
		if (states == null) {
			states = new EObjectContainmentWithInverseEList<State>(State.class, this, GfsmPackage.FSM__STATES, GfsmPackage.STATE__FSM);
		}
		return states;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, GfsmPackage.FSM__TRANSITIONS, GfsmPackage.TRANSITION__FSM);
		}
		return transitions;
	}
		...
		if (initialstate != null && initialstate.eIsProxy()) {
			...
			if (initialstate != oldInitialstate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GfsmPackage.FSM__INITIALSTATE, oldInitialstate, initialstate));
			}
		}
		return initialstate;
	}
	...
	public void setInitialstate(InitialState newInitialstate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GfsmPackage.FSM__INITIALSTATE, oldInitialstate, initialstate));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GfsmPackage.FSM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GfsmPackage.FSM__INITIALSTATE:
