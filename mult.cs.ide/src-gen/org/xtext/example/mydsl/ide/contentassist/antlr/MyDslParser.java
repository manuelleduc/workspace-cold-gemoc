		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMultAccess().getRightAssignment_1_2(), "rule__Mult__RightAssignment_1_2");
					put(grammarAccess.getCstAccess().getValueAssignment_1(), "rule__Cst__ValueAssignment_1");
				}
			};
		}
